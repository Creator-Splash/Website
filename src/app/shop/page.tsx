...
export default function Shop() {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Check out our latest collection of premium
                            merchandise
                        </p>
                    </div>
            ...
            <section className="bg-black max-w-9xl mb-8 sm:mb-12 md:mb-16 lg:mb-16 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 mx-4 sm:mx-8 md:mx-16 lg:mx-78 relative overflow-hidden">
                {/* Small image in bottom left */}
                <div className="hidden lg:block absolute -bottom-30 -right-30 -rotate-25">
                    <Image
                ...
                <div
                    className="flex items-center justify-center mb-6 sm:mb-8 md:mb-10 lg:mb-0"
                    id="st"
                >
                    <img
                        ...
                        height="134"
                        alt="Stickers"
                        className="max-w-full h-auto w-[250px] sm:w-[350px] md:w-[400px] lg:w-[507px]"
                    />
                </div>
                <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row items-center justify-center mx-0 sm:mx-4 md:mx-8 lg:mx-96 gap-6 sm:gap-8 md:gap-12 lg:gap-40 py-8 sm:py-10 md:py-12 lg:py-16">
                    <Link
                    ...
                    >
                        <Image
                            ...
                            height={240}
                            alt="sticker 1"
                            className="rounded-2xl cursor-pointer transition-all duration-300 hover:scale-[1.05] w-full max-w-[280px] sm:max-w-[320px] md:max-w-[350px] lg:max-w-[380px] h-auto"
                        />
                    </Link>
                    <Link
                    ...
                    >
                        <Image
                            ...
                            height={240}
                            alt="sticker 2"
                            className="rounded-2xl cursor-pointer transition-all duration-300 hover:scale-[1.05] w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-[400px] h-auto"
                        />
                    </Link>
                </div>
            </section>
